...
public class ARDrawManager : Singleton<ARDrawManager>
{
    ...
    [SerializeField, Range(0, 1.0f)] private float minDistanceBeforeNewPoint = 0.01f;
    ...
    void DrawOnTouch()
    {
        ...
        Vector3 touchPosition = arCamera.ScreenToWorldPoint(new Vector3(Input.GetTouch(0).position.x, Input.GetTouch(0).position.y));
